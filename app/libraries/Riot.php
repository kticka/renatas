<?php
	Class Riot {
		...
		public function stats() {
			$this->request('api/lol/eune/v1.3/stats/by-summoner/'.$this->user['id'].'/summary');
			return $this->doRequest();
		}

		private function getPlayerByName($nickname) {
			$this->request('api/lol/eune/v1.4/summoner/by-name/'.$nickname);
		...
		private function request($request) { 
			if ((!isset($this->request)) || ($this->request == '')) { $this->request = 'https://na.api.pvp.net/'; }
